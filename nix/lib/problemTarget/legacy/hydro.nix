...

    {
      ...
      __functor =
        ...
        let
          ...
          // lib.optionalAttrs (checker != null) modeConfig.checkerField
...
in
{
  batch = args: mkHydroTarget (args // { mode = "batch"; });
  stdioInteraction = args: mkHydroTarget (args // { mode = "stdioInteraction"; });
  answerOnly = args: mkHydroTarget (args // { mode = "answerOnly"; });
}
