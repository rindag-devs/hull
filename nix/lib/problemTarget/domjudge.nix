      ...
      __functor =
        ...
        let
          modeConfig =
            {
              batch = {
                ...
                iniLines = [ "special_compare='compare'" ];
                yamlTypeSuffix = "";
                yamlValidationSuffix = "";
              };
              stdioInteraction = {
                checkerPatch = {
                ...
                iniLines = [ "special_run='run'" ];
                yamlTypeSuffix = " interactive";
                yamlValidationSuffix = " interactive";
              };
            }
            .${mode};
          ...
          yamlContent = builtins.toJSON {
            name = problemDisplayName;
            type = "pass-fail${modeConfig.yamlTypeSuffix}";
            validation = "custom${modeConfig.yamlValidationSuffix}";
            limits = {
...
in
{
  batch = args: mkDomjudgeTarget (args // { mode = "batch"; });
  stdioInteraction = args: mkDomjudgeTarget (args // { mode = "stdioInteraction"; });
}
